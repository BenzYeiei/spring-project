...
import com.service.backend.Filter.CheckTokenFilter;
...
public class ConfigSecurity extends WebSecurityConfigurerAdapter {
    ...
    "/api/images/**",
            ...
            "/api/tests/redis",
            "/api/tests/connect-microservice/**",
            "/api/tests/fire-base/**"
        ).permitAll();
        ...
        http.authorizeRequests()
                // public
                // request ADMIN and USER
                .antMatchers(HttpMethod.GET, "/api/animals/v1/illustration").hasAnyAuthority("ADMIN", "USER")
                .antMatchers(HttpMethod.POST, "/api/animals/v1/illustration").hasAnyAuthority("ADMIN", "USER")
                .antMatchers(HttpMethod.PUT, "/api/animals/v1/illustration").hasAnyAuthority("ADMIN", "USER")
                .antMatchers(HttpMethod.DELETE, "/api/animals/v1/illustration").hasAnyAuthority("ADMIN", "USER")
        ;
